...
\begin{frame}
  ...
  {\color{blue} Many other directions to explore, many reasons to
    do so:}
  \begin{center}
    \begin{tikzpicture}[small mindmap, grow cyclic, concept color=red!70]
      \tikzset{concept/.append style={fill={none}}}
      \node[concept] {Non-minimal models}
      [clockwise from=30]
      child[concept] {
        node[concept] {$R$-parity?}
        child[concept] { node[concept] {Relax? $\Rightarrow$ RPV-MSSM} }
        child[concept] { node[concept] {Exact $R$-symmetry?
            $\Rightarrow$ MRSSM} }
      }
      child[concept] {
        node[concept] {Naturalness?}
        [clockwise from=-20]
        child[concept] { node[concept] { NMSSM etc. } }
      }
      child[concept] {
        node[concept] {Unification?}
        [clockwise from=190]
        child[concept] { node[concept] {SUSY-GUTs} }
      }
      child[concept] {
        node[concept] {Gravity?}
        [clockwise from=140]
        child[concept] { node[concept] {String-inspired models}
        }
      };
    \end{tikzpicture}
  \end{center}
...
\begin{frame}
  ...
  \item E.g., supplement $\textbf{27}$-plets by components of
    ...
    \begin{empheq}[box=\widefbox]{align*}
      W_{\text{SE}_6\text{SSM}} = {} & \, \lambda {\color{orange} S}
      ({\color{orange} H_d} \cdot {\color{orange} H_u})
      - \sigma \phi {\color{orange} S}
      {\color{orange} \overline{S}}
      + \frac{\kappa}{3} \phi^3 + \frac{\mu}{2} \phi^2
      + \Lambda_F \phi + \lambda_{\alpha\beta} {\color{orange} S}
      ( H^d_{\alpha} \cdot H^u_{\beta}) \\
      & {} + \kappa_{ij} {\color{orange} S}
      D_{i} \overline{D}_{j}
      + \tilde{f}_{i\alpha} S_{i} ({\color{orange} H_u} \cdot
      H^d_{\alpha}) + f_{i\alpha} S_{i} (H^u_{\alpha}
      \cdot {\color{orange} H_d})
      + g^D_{ij} (Q_i \cdot {\color{orange} L_4})
      \overline{D}_j \\
      & {} + h^E_{i\alpha} e^c_{i} (H^d_{\alpha} \cdot
          {\color{orange} L_4})
          + \mu_L({\color{orange} L_4} \cdot
          {\color{orange} \overline{L}_4}) + \tilde{\sigma}
          \phi ({\color{orange} L_4} \cdot
              {\color{orange} \overline{L}_4})
              + W^{RPC}_{\text{MSSM}}(\mu=0)
    \end{empheq}
